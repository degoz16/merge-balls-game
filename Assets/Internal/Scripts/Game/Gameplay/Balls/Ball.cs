...
namespace Internal.Scripts.Game.Gameplay.Balls {
    public class Ball : MonoBehaviour {
        ...
        public static event EventHandler BallsCountChangedEvent = delegate {  };
        ...
        public int PowerProperty {
            ...
            set {
                ...
                var colorScheme = GlobalControl.Instance.ColorScheme;
        ...
        private void Start() {
            BallsCountChangedEvent(this, EventArgs.Empty);
        }
